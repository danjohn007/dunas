...
-- - YYYYMMDD: Entry date
-- - XXXXXXXX: 8 character random hex string (uppercase)
-- 
-- Note: New pass codes are generated by the Visitor model's
-- generatePassCode() method. This SQL migration only handles
-- legacy records that don't have a pass_code yet.
-- =====================================================
