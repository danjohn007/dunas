...
<head>
    ...
    <title>Pase de Visita - <?php echo htmlspecialchars($visitor['pass_code'] ?? 'Sin código'); ?></title>
    ...
    <div class="max-w-3xl mx-auto px-4 pb-8">
        <div class="pass-container bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="pass-header text-white p-6">
                ...
                <p class="text-white/80">Código: <?php echo htmlspecialchars($visitor['pass_code'] ?? 'N/A'); ?></p>
            </div>
