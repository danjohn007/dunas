...
try {
    ...
    // Get the most recent detected plate (sin límite de tiempo)
    $stmt = $db->prepare("
    ...
    if ($result) {
        ...
        // Solo devuelve false si la tabla está completamente vacía
        echo json_encode([
            'success' => false,
            'message' => 'No hay placas detectadas en la base de datos',
            'plate' => null
        ]);
    }
